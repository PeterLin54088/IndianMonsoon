...
years=(); levels=();
for complete_filename in ${varname}_*[0-9]*_*[0-9]*.nc; do
...
do
    ...
    -del29feb \
    -mergetime \
    ${source_path}/${varname}/${varname}_${plevel}_*[0-9]*.nc \
...
# cdo --reduce_dim -selvar,svo -sellevel,92500 div_vor.nc vor925.nc